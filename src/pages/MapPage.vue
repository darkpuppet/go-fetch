    ...
    <section class="container map-grid">
      <div class="map-sidebar">
        ...
        <q-list bordered separator class="truck-list rounded-borders bg-white">
          <q-item v-for="truck in trucks" :key="truck.id" clickable @click="selectedTruckId = truck.id">
      ...
      <FoodTruckMap class="map-panel" :trucks="trucks" :selected-truck-id="selectedTruckId" />
    </section>
  </q-page>
</template>
